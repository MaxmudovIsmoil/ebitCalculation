        ...
        <td colspan="3">
            <table>
                ...
                <tr class="common-border">
                    ...
                    <td class="common-border" ><div class="centering-content">Date:  «22» Июнь 2024 г.</div></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2" class="common-border">
                        <div class="value-container">
                            <div class="value-item">
                                <strong>Расход оборудования и материалов: </strong>
                            </div>
                           <div>
                                 <strong>Работа и расходные материалы: </strong>
                           </div>
                           <div>
                                 <strong>ЛКС: </strong>
                           </div>
                ...
                <tr>
                    ...
                    <td colspan="2" class="common-border">
                        <div class="value-container">
                            <div class="value-item">
                                <strong>Плата за организацию абонентской линии –
                ...
                <tr>
                    ...
                    <td colspan="2" class="common-border">
                        <div class="value-container">
                            <div class="value-item">
                              <strong>«___» рабочих дней с / без учета запретов </strong> 
...
<style scoped>
    ...
    .signature-container {
        display: flex;
        align-items: flex-end; /* Aligns the bottom of the line and title */
    ...
    .signature-line-container {
        ...
        flex-direction: column;
        align-items: center;
        margin-right: 10px; /* Spacing between the line and the title */
        position: relative;
    }

    .signature-line {
        width: 250px; /* Adjust the width of the line as needed */
        border-bottom: 1px solid black;
    }

    .signature-placeholder {
        font-size: 10px; /* Adjust the size of the "подпись" text */
        position: absolute;
        bottom: -15px; /* Adjust the position of the "подпись" text */
        left: 50%;
